...
<head>
    ...
    <!-- CSS Files -->
    <link rel="stylesheet" href="{{ url('landing-assets/css/animate-3.7.0.css') }}">
    <link rel="stylesheet" href="{{ url('landing-assets/css/font-awesome-4.7.0.min.css') }}">
    <link rel="stylesheet" href="{{ url('landing-assets/css/bootstrap-4.1.3.min.css') }}">
    <link rel="stylesheet" href="{{ url('landing-assets/css/owl-carousel.min.css') }}">
    <link rel="stylesheet" href="{{ url('landing-assets/css/jquery.datetimepicker.min.css') }}">
    ...
    <header class="header-area">
        ...
        <div id="header" id="home">
            <div class="container">
                ...
                <div id="logo">
                    <a href="index.html"><img style="margin-top: 12px" height="50px" src="{{ url('landing-assets/images/logo/logo-use.png') }}" alt="" title="" /></a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding">
                        <img src="{{ url('landing-assets/images/feature1.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-md-0">
                        <img src="{{ url('landing-assets/images/feature2.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="{{ url('landing-assets/images/feature3.png') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-feature text-center item-padding mt-4 mt-lg-0">
                        <img src="{{ url('landing-assets/images/feature4.png') }}" alt="">
            ...
            <div class="row">
                <div class="col-lg-5 align-self-center">
                    <div class="welcome-img">
                        <img src="{{ url('landing-assets/images/welcome.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-7">
                ...
                <div class="col-lg-12">
                    <div class="department-slider owl-carousel">
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ url('landing-assets/images/department1.jpg') }}" alt="" class="img-fluid">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ url('landing-assets/images/department2.jpg') }}" alt="" class="img-fluid">
                                <div class="hover-state">
                        ...
                        <div class="single-slide">
                            <div class="slide-img">
                                <img src="{{ url('landing-assets/images/department3.jpg') }}" alt="" class="img-fluid">
                                <div class="hover-state">
                                    <a href="departments.html"><i class="fa fa-stethoscope"></i></a>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="single-patient mb-4">
                        <img src="{{ url('landing-assets/images/patient1.png') }}" alt="">
                        <h3>daren jhonson</h3>
                        <h5>hp specialist</h5>
                    ...
                    <div class="single-patient">
                        <img src="{{ url('landing-assets/images/patient2.png') }}" alt="">
                        <h3>black heiden</h3>
                        <h5>hp specialist</h5>
                        <p class="pt-3">Elementum libero hac leo integer. Risus hac road parturient feugiat. Litora cursus hendrerit bib elit Tempus inceptos posuere metus.</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-lg-0">
                        <div class="doctor-img">
                            <img src="{{ url('landing-assets/images/doctor1.jpg') }}" alt="" class="img-fluid">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-lg-0">
                        <div class="doctor-img">
                            <img src="{{ url('landing-assets/images/doctor2.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>dand mories</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor mb-4 mb-sm-0">
                        <div class="doctor-img">
                            <img src="{{ url('landing-assets/images/doctor3.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>align board</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-doctor">
                        <div class="doctor-img">
                            <img src="{{ url('landing-assets/images/doctor4.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="content-area">
                            <div class="doctor-name text-center">
                                <h3>jeson limit</h3>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-news">
                        <div class="news-img">
                            <img src="{{ url('landing-assets/images/news1.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 July 2018
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news mt-5 mt-md-0">
                        <div class="news-img">
                            <img src="{{ url('landing-assets/images/news2.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 Oct 2018
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-news mt-5 mt-lg-0">
                        <div class="news-img">
                            <img src="{{ url('landing-assets/images/news3.jpg') }}" alt="" class="img-fluid">
                        </div>
                        <div class="news-text">
                            <div class="news-date">
                                22 Sep 2018
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 offset-xl-1 col-lg-3">
                        <div class="single-widge-home">
                            ...
                            <div class="feed">
                                <img src="{{ url('landing-assets/images/feed1.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed2.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed3.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed4.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed5.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed6.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed7.jpg') }}" alt="feed">
                                <img src="{{ url('landing-assets/images/feed8.jpg') }}" alt="feed">
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    <!-- Javascript -->
    <script src="{{ url('landing-assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
	<script src="{{ url('landing-assets/js/vendor/bootstrap-4.1.3.min.js') }}"></script>
    <script src="{{ url('landing-assets/js/vendor/wow.min.js') }}"></script>
    <script src="{{ url('landing-assets/js/vendor/owl-carousel.min.js') }}"></script>
    <script src="{{ url('landing-assets/js/vendor/jquery.datetimepicker.full.min.js') }}"></script>
    <script src="{{ url('landing-assets/js/vendor/jquery.nice-select.min.js') }}"></script>
    <script src="{{ url('landing-assets/js/vendor/superfish.min.js') }}"></script>
